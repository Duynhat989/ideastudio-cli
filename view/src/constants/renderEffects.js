/** ESM mirror of src/shared/renderEffects.js — giữ đồng bộ khi sửa hiệu ứng. */
export const OUTPUT_FPS = 30;
export const FRAME_DUR = 1 / OUTPUT_FPS;

export const FADE_EFFECT_TYPES = [
...
export const computePreviewOpacity = (clip, relTime, clipDuration) => {
  let opacity = 1;
...
export const defaultClipEffects = () => ({
  fadeInType: 'none',
  fadeInDuration: 0.5,
  fadeOutType: 'none',
  fadeOutDuration: 0.5,
...
export const ensureClipEffects = (clip) => {
